...
def __generate_certificate__():
    ...
    #         add_text(img, f"{doc}: {checks_correct/checks*100:.0f}%", pos_y=pY, pos_x=pX+logo_size[1]+mx, scale=scale, thickness=thickness, horizontal_align="justify", color=COLOR_BAD)
        ...
        text_str = f"{checks_correct}/{checks}"
        (w, h), _ = cv.getTextSize(text_str, cv.FONT_HERSHEY_SIMPLEX, h3_scale, thickness)
        pX += c_w - w - 4*mx
        add_text(img, text_str, pos_y=pY, pos_x=pX, scale=h3_scale, thickness=thickness, horizontal_align="justify", color=color)
        pass
    ...
    posY = add_text(img, f"Final Score: {correct} / {total} Tests passed ({score:.2f}%)", pos_y=posY, scale=h2_scale, thickness=4, horizontal_align="center", color=color) + margin_big
    ...
    if passed:
        ...
        posY = add_text(img, f"Please try again to improve your score to {min_score:.0f}%.", pos_y=posY, scale=h3_scale, thickness=2, horizontal_align="center", color=COLOR_BAD) + margin_small
    ...
    add_text(img, f"{date_str}", pos_y=img.shape[0]-50, scale=h3_scale, thickness=2, horizontal_align="right")
    
    fname = f"certificate_python_fundamentals_{last_name}_{first_name}"
...
def _get_attribut_from_notebook(var_name):
    ...
    global checks_correct
    if hasattr(__main__, var_name):
        checks_correct += 1
        print(f"✅ Attribut '{var_name}' im Notebook gefunden.")
        return getattr(__main__, var_name)
    else:
        print(f"❌ Attribut '{var_name}' nicht im Notebook gefunden.")
...
def task_3_1():
    ...
    try:
        ...
        validation_results['task_3_1'] = (checks_correct, checks)
...
def task_3_2():
    ...
    try:
        ...
        validation_results['task_3_2'] = (checks_correct, checks)
    ...
    try:
        ...
        if (isinstance(student, dict)):
            if 'name' not in student:
                ...
                print(f"✅ Der Schlüssel 'name' ist im Dictionary 'student' vorhanden.")
                checks_correct += 1

            if 'mat_nr' not in student:
                print(f"❌ Der Schlüssel 'mat_nr' fehlt im Dictionary 'student'.")
            else:
                print(f"✅ Der Schlüssel 'mat_nr' ist im Dictionary 'student' vorhanden.")
                checks_correct += 1
            
            if 'study_program' not in student:
                print(f"❌ Der Schlüssel 'study_program' fehlt im Dictionary 'student'.")
            else:
                print(f"✅ Der Schlüssel 'study_program' ist im Dictionary 'student' vorhanden.")
                checks_correct += 1
            
            if 'semester' not in student:
                print(f"❌ Der Schlüssel 'semester' fehlt im Dictionary 'student'.")
            else:
                print(f"✅ Alle erforderlichen Schlüssel sind im Dictionary 'student' vorhanden.")
                checks_correct += 1
            
            if not type(student.get('name')) == str:
                print(f"'❌ student' ist kein Dictionary.")
            else:
                print(f"✅ Der Schlüssel 'name' ist im Dictionary 'student' vorhanden und vom Typ str.")
                checks_correct += 1
            
            if not type(student.get('mat_nr')) in [int, str]:
                print(f"❌ 'mat_nr' ist weder Zeichenkette noch Integer. Aktueller Typ: {type(student['mat_nr'])}")
            else:
                print(f"✅ Der Schlüssel 'mat_nr' ist im Dictionary 'student' vorhanden und vom Typ int oder str.")
                checks_correct += 1
            
            if not type(student.get('study_program')) == str:
                print(f"❌ 'study_program' ist keine Zeichenkette. Aktueller Typ: {type(student['study_program'])}")
            else:
                print(f"✅ Der Schlüssel 'study_program' ist im Dictionary 'student' vorhanden und vom Typ str.")
                checks_correct += 1
            
            if not type(student.get('semester')) == int:
                print(f"❌ 'semester' ist kein Integer. Aktueller Typ: {type(student['semester'])}")
            else:
                print(f"✅ Der Schlüssel 'semester' ist im Dictionary 'student' vorhanden und vom Typ int.")
                checks_correct += 1
        else:
        ...
        validation_results['task_4_1'] = (checks_correct, checks)
...
def task_4_2():
    ...
    try:
        ...
        validation_results['task_4_2'] = (checks_correct, checks)
...
def task_5_1():
    ...
    try:
        ...
        validation_results['task_5_1'] = (checks_correct, checks)
...
def task_5_2():
    ...
    try:
        ...
        validation_results['task_5_2'] = (checks_correct, checks)
...
def task_6_1():
    ...
    try:
        ...
        validation_results['task_6_1'] = (checks_correct, checks)
...
def task_6_2():
    ...
    try:
        ...
        validation_results['task_6_2'] = (checks_correct, checks)
...
def task_6_3():
    ...
    try:
        ...
        validation_results['task_6_3'] = (checks_correct, checks)
...
def task_7_1():
    ...
    try:
        ...
        if not callable(area_function):
            ...
            print("✅ 'calculate_area' ist als Funktion definiert.")
            checks_correct += 1
        ...
        if not area_function(a, b) == a * b:
            ...
            print(f"✅ Die Funktion 'calculate_area' liefert korrekte Ergebnisse für a={a}, b={b}.")
            checks_correct += 1
        ...
        validation_results['task_7_1'] = (checks_correct, checks)
...
def task_7_2():
    ...
    try:
        ...
        if not callable(prime_function):
            ...
            print("✅ 'is_prime' ist als Funktion definiert.")
            checks_correct += 1
        ...
        if not isinstance(number, int):
            ...
            print("✅ 'number' ist eine ganze Zahl.")
            checks_correct += 1
        ...
        validation_results['task_7_2'] = (checks_correct, checks)
...
def task_7_3():
    ...
    try:
        ...
        if not callable(sum_function):
            ...
            print("✅ 'calculate_sum' ist als Funktion definiert.")
            checks_correct += 1
        ...
        validation_results['task_7_3'] = (checks_correct, checks)
...
def task_8_1():
    ...
    try:
        ...
        validation_results['task_8_1'] = (checks_correct, checks)
...
def task_8_2():
    ...
    try:
        ...
        validation_results['task_8_2'] = (checks_correct, checks)
...
def task_8_3():
    ...
    try:
        ...
        validation_results['task_8_3'] = (checks_correct, checks)
...
def task_9_1():
    ...
    try:
        ...
        validation_results['task_9_1'] = (checks_correct, checks)
...
def task_9_2():
    ...
    try:
        ...
        validation_results['task_9_2'] = (checks_correct, checks)
...
def task_10_1():
    ...
    try:
        ...
        validation_results['task_10_1'] = (checks_correct, checks)
...
def task_10_2():
    ...
    try:
        ...
        validation_results['task_10_2'] = (checks_correct, checks)
...
def task_11_1():
    ...
    try:
        ...
        validation_results['task_11_1'] = (checks_correct, checks)
...
def task_11_2():
    ...
    try:
        ...
        validation_results['task_11_2'] = (checks_correct, checks)
...
def task_11_3():
    ...
    try:
        ...
        validation_results['task_11_3'] = (checks_correct, checks)
...
def task_12_1():
    ...
    try:
        ...
        validation_results['task_12_1'] = (checks_correct, checks)
...
def task_12_2():
    ...
    try:
        ...
        validation_results['task_12_2'] = (checks_correct, checks)
...
def task_13_1():
    ...
    try:
        ...
        validation_results['task_13_1'] = (checks_correct, checks)
...
def task_13_2():
    ...
    try:
        ...
        validation_results['task_13_2'] = (checks_correct, checks)
...
def task_13_3():
    ...
    try:
        ...
        if std < 0.95 or std > 1.05 or np.abs(mean) > 0.08:
        ...
        validation_results['task_13_3'] = (checks_correct, checks)
...
def task_14_1():
    ...
    try:
        ...
        validation_results['task_14_1'] = (checks_correct, checks)
...
def task_14_2():
    ...
    try:
        ...
        validation_results['task_14_2'] = (checks_correct, checks)
...
def task_14_3():
    ...
    try:
        ...
        validation_results['task_14_3'] = (checks_correct, checks)
