...
> **Hinweis:** Diese Einleitung wurde KI-generiert (GitHub Copilot mit Claude Sonnet 4.5)

📝 **[Zu den Übungsaufgaben →](uebungen.ipynb)** - Teste dein Wissen mit praktischen Aufgaben im Jupyter Notebook!

## Einleitung

Python ist eine vielseitige, leicht zu erlernende Programmiersprache, die für ihre klare Syntax und Lesbarkeit bekannt ist. Sie wurde 1991 von Guido van Rossum entwickelt und hat sich zu einer der beliebtesten Sprachen weltweit entwickelt.

### Warum Python?

- **Einfach zu lernen**: Die Syntax ist klar und intuitiv
- **Vielseitig einsetzbar**: Von Webentwicklung über Datenanalyse bis hin zu künstlicher Intelligenz
- **Große Community**: Umfangreiche Bibliotheken und aktive Unterstützung
...
- Machine Learning und KI (TensorFlow, PyTorch)
- Automatisierung und Scripting
- Wissenschaftliches Rechnen (NumPy, SciPy)

Dieses Repository bietet eine strukturierte Einführung in die Grundlagen von Python.

---

## 1. Variablen und Datentypen

Variablen speichern Werte und benötigen in Python keine Typ-Deklaration.

```python
# Zahlen
alter = 25                    # Integer (Ganzzahl)
temperatur = 23.5             # Float (Fließkommazahl)
komplex = 3 + 4j              # Complex (komplexe Zahl)
